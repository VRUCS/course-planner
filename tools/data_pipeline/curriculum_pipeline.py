...
CANONICAL_DATA_DIR = ROOT / "data/canonical"
GENERATED_WEB_DIR = ROOT / "apps/web/generated"
CURRICULA_PATH = CANONICAL_DATA_DIR / "curricula.json"
RULES_PATH = CANONICAL_DATA_DIR / "conflict_rules.json"
COURSES_PATH = CANONICAL_DATA_DIR / "courses.json"
CURRICULA_JS_PATH = GENERATED_WEB_DIR / "curriculum.generated.js"
RULES_JS_PATH = GENERATED_WEB_DIR / "conflict-rules.generated.js"
...
def wrapper_text(variable: str, payload: object, source: str) -> str:
    ...
    return (
        f"/** Generated from {source} by tools/data_pipeline/curriculum_pipeline.py. */\n"
